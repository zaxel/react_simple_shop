...
const NavSearchBar = observer(() => {
  ...
  const renderSuggestions = () => {
    ...
    return (
      <ul
        ...
        className={`shop-search__suggestions suggestions ${phrase === "" ? "suggestions__history" : "suggestions__response"
          }`}
      >
  ...
  return (
    <div className="shop-search w-full max-w-96 h-8 m-auto xl:order-2"> 
      <div className="">
        <div className="">
          <form
            onSubmit={(e) => e.preventDefault()}
            className="shop-search__search-box h-8 !rounded-xl"
          >
            <div className="flex justify-between h-8">
              ...
              <input
                ...
                type="text"
                className="!static border-none form-control h-8 rounded-l-xl"
              ...
              <button
                ...
                className="shop-search__search-button !relative h-8 !rounded-r-xl"
              >
                <img
