...
import { Context } from '../../../../..';
import { changeCatData, changeCatImg } from '../../../../../utils/staticPages/helpPage';
...
const CategoryCardBody = observer(({ id, title, banner, icon, link }) => {
    ...
    const updateCatImg = (formData) => {
        changeCatImg(formData, helpAdmin);
    }
            ...
            <div className='about-blocks__body-imgs'>
                    ...
                    <div className='about-blocks__body-images'>
                        <div className='about-blocks__body-image'>
                            ...
                            <AdminImage id={id} index={0} inputTitle={'main banner:'} inputData={banner} imgDbCollName={'banner'} cb={updateCatImg} alt={'banner'} />
                        </div>
                        <div className='about-blocks__body-image'>
                            <AdminImage id={id} index={1} inputTitle={'icon:'} inputData={icon} imgDbCollName={'icon'} cb={updateCatImg} alt={'icon'} />
                        </div>
                    </div>
                </div>
