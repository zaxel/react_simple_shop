...
import { SHOP_ROUTE as to, ABOUT_CARD3_ROUTE } from '../../utils/consts/routes';
...
const About = () => {
    const aboutCardsData = [
        ...
        {hero: hero3, title: 'The ARAZONE experience', descr: 'Cos there\'s so much more to us', buttonText: 'discover it now', to: ABOUT_CARD3_ROUTE},
