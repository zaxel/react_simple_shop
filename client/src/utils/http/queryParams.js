...
export const setQueryParamsString = (setSearchParams, store) => {
    const paramsNames = ['searchKey','id', 'sortBy', 'sortDirection', 'itemsPerPage', 'activePage', 'searchBy', 'searchByPrase', 'brandActive', 'typeActive'];
    let params = {};
...
export const getQueryParamsString = (searchParams, store) => {
    const allowedParamsNames = ['searchKey', 'id', 'sortBy', 'sortDirection', 'itemsPerPage', 'activePage', 'searchBy', 'searchByPrase', 'brandActive', 'typeActive'];
